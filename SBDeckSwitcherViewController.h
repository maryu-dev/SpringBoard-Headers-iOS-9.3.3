...
- (void)_setNormalizedScrollProgress:(double)arg1 animated:(_Bool)arg2 completion:(id)arg3;
- (double)_normalizedScrollProgress;
- (double)_desiredXOriginForQuantizedTopPage;
- (void)_setContentOffset:(struct CGPoint)arg1 animated:(_Bool)arg2 completion:(id)arg3;
- (void)_updateScrollViewContentOffsetToCenterIndex:(unsigned long long)arg1 animated:(_Bool)arg2 completion:(id)arg3;
- (void)_updateContentSizePreservingScrollPositionOfPriorIndex:(unsigned long long)arg1 subsequentIndex:(unsigned long long)arg2 acrossMutation:(id)arg3;
- (void)_updateContentSizePreservingScrollPositionOfDisplayItem:(id)arg1 atOriginalIndex:(unsigned long long)arg2 acrossMutation:(id)arg3;
...
- (id)_insertionRemovalStatusForDisplayItem:(id)arg1;
