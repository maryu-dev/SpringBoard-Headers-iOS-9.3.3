...
- (void)_enqueueWorkspaceEvent:(id)arg1 withName:(id)arg2 ifSatisfiesCondition:(id)arg3 cancelingEventsWithNames:(id)arg4;
...
- (void)_computeVolumeButtonsHavePrecedenceWithHandler:(id)arg1;
