...
- (_Bool)removeLockScreenNotificationsPassingTest:(id)arg1;
...
- (void)_turnOnScreen;
- (void)_shouldTurnOnScreenForItem:(id)arg1 withResult:(id)arg2;
- (_Bool)_shouldDeterminePocketState;
- (_Bool)_isPocketDetectionEnabled;
- (void)_disablePocketDetection;
- (void)_enablePocketDetection;
- (void)turnOnScreenIfNecessaryForItem:(id)arg1 withCompletion:(id)arg2;
