...
- (void)_presentAuthenticationUIForInstallation:(id)arg1 withInstallType:(unsigned long long)arg2 withInstallOperation:(id)arg3;
...
- (void)autoInstallOperationIsReadyToInstall:(id)arg1 withResponse:(id)arg2;
...
- (void)_createInstallTonightOperationWithResult:(id)arg1;
