...
- (void)_animateLayoutElementViewController:(id)arg1 withAnimationSettings:(id)arg2 precondition:(id)arg3 animationBlock:(id)arg4 completion:(id)arg5;
- (void)_animateOutLayoutElementViewInRole:(long long)arg1 withAnimationSettings:(id)arg2 animationBlock:(id)arg3 completion:(id)arg4;
- (void)_animateInLayoutElementViewInRole:(long long)arg1 withAnimationSettings:(id)arg2 animationBlock:(id)arg3 completion:(id)arg4;
- (void)_fadeOutLayoutElementViewInRole:(long long)arg1 withAnimationSettings:(id)arg2 completion:(id)arg3;
- (void)_fadeInLayoutElementViewInRole:(long long)arg1 withAnimationSettings:(id)arg2 completion:(id)arg3;
- (void)_fadeInSideAppWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_slideInSideAppWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_fadeOutSideAppWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_slideOutSideAppWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_fadeOutScenesForZoomDownWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_slideOutScenesForZoomDownWithAnimationSettings:(id)arg1 completion:(id)arg2;
...
- (void)_transitionToOrFromSideSwitcherForPresenting:(_Bool)arg1 completion:(id)arg2;
- (void)_resizeAppViewsWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_rotateAppViewsWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_makeSideAppControllerPrimaryWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_popSideAppControllerWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)_pushSideAppOverlayController:(id)arg1 dimOtherViews:(_Bool)arg2 withAnimationSettings:(id)arg3 fadeIn:(_Bool)arg4 completion:(id)arg5;
- (void)_pushSideAppOverlayController:(id)arg1 withAnimationSettings:(id)arg2 completion:(id)arg3;
- (void)_pushSideAppControllerForSwitcher:(id)arg1 withAnimationSettings:(id)arg2 fadeIn:(_Bool)arg3 completion:(id)arg4;
- (void)pushLayoutElementViewController:(id)arg1 withAnimationSettings:(id)arg2 completion:(id)arg3;
- (void)pushLayoutElementViewController:(id)arg1 withCompletion:(id)arg2;
- (void)popLayoutElementViewControllerWithAnimationSettings:(id)arg1 completion:(id)arg2;
- (void)popLayoutElementViewControllerWithCompletion:(id)arg1;
